...
```{r}
#Function to simulate a coin flip. Returns 1 for Tails, 0 for Heads. Uses a uniform distr to sample, and cut of >0.5 to cutoff for tails (could have been <0.5 doesn't matter)
