...
#Run Newtons Method
results <- nr(x = exp_data,n=length(exp_data),lambda= 5,mu=0.0001)
# results  

print(paste("Result Of Newtons Method When it Converges:",tail(results,1)))
#Seems to converge. But I know it's not the right answer.

print("Method appear to give me the mean which is incorrect, but I know the inverse of this is the solution")
print(paste("1/result=",tail(1/results,1)))
